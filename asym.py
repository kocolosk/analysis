...
class Polarizations:
    ...
    7602 : PolarizationRecord(7602, 'final',    0.4113, 0.0194, 0.3999, 0.0170),
    7603 : PolarizationRecord(7603, 'final',    0.4354, 0.0180, 0.3987, 0.0164),
    7605 : PolarizationRecord(7605, 'final',    0.4646, 0.0215, 0.4755, 0.0217),
    7609 : PolarizationRecord(7609, 'final',    0.5372, 0.0176, 0.4841, 0.0211),
    7610 : PolarizationRecord(7610, 'final',    0.4818, 0.0194, 0.4044, 0.0180),
    7621 : PolarizationRecord(7621, 'final',    0.4966, 0.0240, 0.4966, 0.0240),
    7622 : PolarizationRecord(7622, 'final',    0.4691, 0.0189, 0.5161, 0.0184),
    7627 : PolarizationRecord(7627, 'final',    0.4876, 0.0211, 0.4903, 0.0216),
    7630 : PolarizationRecord(7630, 'final',    0.4997, 0.0201, 0.4818, 0.0200),
    7632 : PolarizationRecord(7632, 'final',    0.4581, 0.0177, 0.4871, 0.0161),
    7637 : PolarizationRecord(7637, 'final',    0.5219, 0.0205, 0.5329, 0.0229),
    7639 : PolarizationRecord(7639, 'final',    0.5440, 0.0180, 0.5306, 0.0192),
    7641 : PolarizationRecord(7641, 'final',    0.5340, 0.0238, 0.5153, 0.0225),
    7642 : PolarizationRecord(7642, 'final',    0.5401, 0.0184, 0.5015, 0.0204),
    7645 : PolarizationRecord(7645, 'final',    0.5493, 0.0219, 0.5174, 0.0257),
    7646 : PolarizationRecord(7646, 'final',    0.5149, 0.0211, 0.4180, 0.0199),
    7651 : PolarizationRecord(7651, 'final',    0.5283, 0.0198, 0.5029, 0.0222),
    7652 : PolarizationRecord(7652, 'final',    0.4934, 0.0193, 0.5025, 0.0235),
    7654 : PolarizationRecord(7654, 'final',    0.5437, 0.0179, 0.5437, 0.0179),
    7655 : PolarizationRecord(7655, 'final',    0.5758, 0.0207, 0.4910, 0.0180),
    7657 : PolarizationRecord(7657, 'final',    0.5403, 0.0159, 0.5460, 0.0135),
    7658 : PolarizationRecord(7658, 'final',    0.4989, 0.0252, 0.4416, 0.0222),
    7662 : PolarizationRecord(7662, 'final',    0.5489, 0.0196, 0.5534, 0.0151),
    7671 : PolarizationRecord(7671, 'final',    0.5224, 0.0190, 0.5224, 0.0190),
    7672 : PolarizationRecord(7672, 'final',    0.5197, 0.0195, 0.4147, 0.0203),
    7673 : PolarizationRecord(7673, 'final',    0.4166, 0.0233, 0.2946, 0.0321),
    7674 : PolarizationRecord(7674, 'final',    0.5323, 0.0338, 0.4578, 0.0251),
    7681 : PolarizationRecord(7681, 'final',    0.3936, 0.0207, 0.4179, 0.0151),
    7682 : PolarizationRecord(7682, 'final',    0.4841, 0.0312, 0.5035, 0.0209),
    7685 : PolarizationRecord(7685, 'final',    0.4813, 0.0211, 0.5314, 0.0340),
    7688 : PolarizationRecord(7688, 'final',    0.5078, 0.0172, 0.4647, 0.0153),
    7689 : PolarizationRecord(7689, 'final',    0.5305, 0.0334, 0.5617, 0.0250),
    7690 : PolarizationRecord(7690, 'final',    0.4802, 0.0270, 0.5587, 0.0183),
    7691 : PolarizationRecord(7691, 'final',    0.5580, 0.0183, 0.5492, 0.0146),
    7697 : PolarizationRecord(7697, 'final',    0.5429, 0.0256, 0.5402, 0.0280),
    7699 : PolarizationRecord(7699, 'final',    0.4802, 0.0231, 0.5438, 0.0203),
    7710 : PolarizationRecord(7710, 'final',    0.4959, 0.0285, 0.5491, 0.0216),
    7711 : PolarizationRecord(7711, 'final',    0.5424, 0.0336, 0.3652, 0.0290),
    7712 : PolarizationRecord(7712, 'final',    0.5187, 0.0224, 0.5155, 0.0243),
    7718 : PolarizationRecord(7718, 'final',    0.5456, 0.0256, 0.5389, 0.0163),
    7722 : PolarizationRecord(7722, 'final',    0.5398, 0.0170, 0.5460, 0.0150),
    7724 : PolarizationRecord(7724, 'final',    0.4914, 0.0169, 0.5019, 0.0152),
    7725 : PolarizationRecord(7725, 'final',    0.5193, 0.0132, 0.5321, 0.0119),
    7729 : PolarizationRecord(7729, 'final',    0.5320, 0.0148, 0.5337, 0.0135),
    7739 : PolarizationRecord(7739, 'final',    0.6047, 0.0232, 0.5586, 0.0228),
    7740 : PolarizationRecord(7740, 'final',    0.5470, 0.0209, 0.5714, 0.0211),
    7744 : PolarizationRecord(7744, 'final',    0.5847, 0.0194, 0.5490, 0.0155),
    7745 : PolarizationRecord(7745, 'final',    0.5375, 0.0172, 0.5631, 0.0186),
    7753 : PolarizationRecord(7753, 'final',    0.5346, 0.0196, 0.4901, 0.0149),
    7756 : PolarizationRecord(7756, 'final',    0.4981, 0.0271, 0.5695, 0.0163),
    7757 : PolarizationRecord(7757, 'final',    0.5274, 0.0309, 0.5772, 0.0258),
    7766 : PolarizationRecord(7766, 'final',    0.4093, 0.0370, 0.4483, 0.0332),
    7772 : PolarizationRecord(7772, 'final',    0.5717, 0.0278, 0.5486, 0.0243),
    7775 : PolarizationRecord(7775, 'final',    0.5942, 0.0199, 0.5513, 0.0201),
    7777 : PolarizationRecord(7777, 'final',    0.5892, 0.0390, 0.5468, 0.0316),
    7780 : PolarizationRecord(7780, 'final',    0.5558, 0.0167, 0.5146, 0.0118),
    7781 : PolarizationRecord(7781, 'final',    0.5241, 0.0190, 0.5010, 0.0122),
    7784 : PolarizationRecord(7784, 'final',    0.5517, 0.0233, 0.5421, 0.0202),
    7785 : PolarizationRecord(7785, 'final',    0.5924, 0.0228, 0.5309, 0.0166),
    7786 : PolarizationRecord(7786, 'final',    0.6245, 0.0276, 0.5720, 0.0204),
    7788 : PolarizationRecord(7788, 'final',    0.5441, 0.0183, 0.5308, 0.0121),
    7789 : PolarizationRecord(7789, 'final',    0.5557, 0.0200, 0.5589, 0.0149),
    7790 : PolarizationRecord(7790, 'final',    0.5857, 0.0210, 0.5342, 0.0141),
    7791 : PolarizationRecord(7791, 'final',    0.5586, 0.0206, 0.5380, 0.0154),
    7792 : PolarizationRecord(7792, 'final',    0.5280, 0.0201, 0.5313, 0.0158),
    7794 : PolarizationRecord(7794, 'final',    0.5799, 0.0214, 0.5548, 0.0165),
    7795 : PolarizationRecord(7795, 'final',    0.5601, 0.0250, 0.5244, 0.0209),
    7796 : PolarizationRecord(7796, 'final',    0.5954, 0.0199, 0.6170, 0.0186),
    7797 : PolarizationRecord(7797, 'final',    0.6090, 0.0207, 0.5627, 0.0183),
    7800 : PolarizationRecord(7800, 'final',    0.5286, 0.0163, 0.5575, 0.0176),
    7801 : PolarizationRecord(7801, 'final',    0.5601, 0.0272, 0.5988, 0.0227),
    7803 : PolarizationRecord(7803, 'final',    0.5552, 0.0198, 0.5867, 0.0151),
    7804 : PolarizationRecord(7804, 'final',    0.5440, 0.0144, 0.5440, 0.0144),
    7805 : PolarizationRecord(7805, 'final',    0.5306, 0.0197, 0.5614, 0.0169),
    7810 : PolarizationRecord(7810, 'final',    0.5617, 0.0179, 0.5419, 0.0146),
    7811 : PolarizationRecord(7811, 'final',    0.5540, 0.0286, 0.5706, 0.0274),
    7812 : PolarizationRecord(7812, 'final',    0.5267, 0.0264, 0.5596, 0.0243),
    7815 : PolarizationRecord(7815, 'final',    0.5294, 0.0174, 0.5451, 0.0159),
    7817 : PolarizationRecord(7817, 'final',    0.5302, 0.0193, 0.5668, 0.0170),
    7820 : PolarizationRecord(7820, 'final',    0.5248, 0.0189, 0.5742, 0.0173),
    7823 : PolarizationRecord(7823, 'final',    0.5415, 0.0192, 0.5737, 0.0207),
    7824 : PolarizationRecord(7824, 'final',    0.5153, 0.0191, 0.5807, 0.0213),
    7825 : PolarizationRecord(7825, 'final',    0.5623, 0.0199, 0.5687, 0.0201),
    7826 : PolarizationRecord(7826, 'final',    0.5357, 0.0200, 0.5633, 0.0189),
    7827 : PolarizationRecord(7827, 'final',    0.5374, 0.0234, 0.5655, 0.0197),
    7830 : PolarizationRecord(7830, 'final',    0.5121, 0.0207, 0.5986, 0.0163),
    7831 : PolarizationRecord(7831, 'final',    0.5424, 0.0189, 0.5761, 0.0175),
    7833 : PolarizationRecord(7833, 'final',    0.5288, 0.0219, 0.5813, 0.0177),
    7847 : PolarizationRecord(7847, 'final',    0.5083, 0.0160, 0.4929, 0.0194),
    7850 : PolarizationRecord(7850, 'final',    0.5479, 0.0158, 0.5708, 0.0163),
    7851 : PolarizationRecord(7851, 'final',    0.5917, 0.0198, 0.5583, 0.0143),
    7852 : PolarizationRecord(7852, 'final',    0.5715, 0.0195, 0.5557, 0.0166),
    7853 : PolarizationRecord(7853, 'final',    0.5544, 0.0139, 0.5921, 0.0168),
    7855 : PolarizationRecord(7855, 'final',    0.6194, 0.0209, 0.5783, 0.0132),
    7856 : PolarizationRecord(7856, 'final',    0.5806, 0.0209, 0.5832, 0.0144),
    7860 : PolarizationRecord(7860, 'final',    0.6219, 0.0188, 0.6119, 0.0203),
    7863 : PolarizationRecord(7863, 'final',    0.6130, 0.0184, 0.5890, 0.0242),
    7864 : PolarizationRecord(7864, 'final',    0.6211, 0.0164, 0.5894, 0.0219),
    7865 : PolarizationRecord(7865, 'final',    0.5200, 0.0139, 0.5687, 0.0283),
    7871 : PolarizationRecord(7871, 'final',    0.6260, 0.0180, 0.6159, 0.0214),
    7872 : PolarizationRecord(7872, 'final',    0.5575, 0.0180, 0.6248, 0.0265),
    7883 : PolarizationRecord(7883, 'final',    0.5497, 0.0227, 0.5704, 0.0347),
    7886 : PolarizationRecord(7886, 'final',    0.5163, 0.0136, 0.5801, 0.0201),
    7887 : PolarizationRecord(7887, 'final',    0.6014, 0.0222, 0.6258, 0.0272),
    7889 : PolarizationRecord(7889, 'final',    0.6076, 0.0224, 0.5639, 0.0236),
    7890 : PolarizationRecord(7890, 'final',    0.5699, 0.0237, 0.6154, 0.0299),
    7891 : PolarizationRecord(7891, 'final',    0.6030, 0.0164, 0.5864, 0.0238),
    7892 : PolarizationRecord(7892, 'final',    0.5958, 0.0176, 0.6273, 0.0204),
    7893 : PolarizationRecord(7893, 'final',    0.6213, 0.0208, 0.6233, 0.0251),
    7896 : PolarizationRecord(7896, 'final',    0.5847, 0.0147, 0.6059, 0.0197),
    7898 : PolarizationRecord(7898, 'final',    0.5779, 0.0160, 0.5686, 0.0184),
    7901 : PolarizationRecord(7901, 'final',    0.6184, 0.0207, 0.5897, 0.0310),
    7908 : PolarizationRecord(7908, 'final',    0.5077, 0.0137, 0.6011, 0.0233),
    7909 : PolarizationRecord(7909, 'final',    0.5300, 0.0175, 0.5980, 0.0242),
    7911 : PolarizationRecord(7911, 'final',    0.5184, 0.0214, 0.6101, 0.0281),
    7913 : PolarizationRecord(7913, 'final',    0.6044, 0.0190, 0.6052, 0.0281),
    7915 : PolarizationRecord(7915, 'final',    0.5644, 0.0183, 0.6081, 0.0198),
    7916 : PolarizationRecord(7916, 'final',    0.4892, 0.0167, 0.6135, 0.0230),
    7918 : PolarizationRecord(7918, 'final',    0.5480, 0.0136, 0.5825, 0.0213),
    7921 : PolarizationRecord(7921, 'final',    0.5779, 0.0190, 0.5640, 0.0194),
    7922 : PolarizationRecord(7922, 'final',    0.5631, 0.0241, 0.5755, 0.0207),
    7926 : PolarizationRecord(7926, 'final',    0.5777, 0.0221, 0.5882, 0.0233),
    7940 : PolarizationRecord(7940, 'final',    0.5200, 0.0486, 0.5185, 0.0385),
    7944 : PolarizationRecord(7944, 'final',    0.5522, 0.0248, 0.5565, 0.0195),
    7946 : PolarizationRecord(7946, 'final',    0.5323, 0.0327, 0.6185, 0.0473),
    7949 : PolarizationRecord(7949, 'final',    0.4963, 0.0171, 0.5488, 0.0168),
    7951 : PolarizationRecord(7951, 'final',    0.5509, 0.0259, 0.5945, 0.0230),
    7952 : PolarizationRecord(7952, 'final',    0.5183, 0.0192, 0.5603, 0.0184),
    7954 : PolarizationRecord(7954, 'final',    0.4989, 0.0224, 0.5814, 0.0208),
    7957 : PolarizationRecord(7957, 'final',    0.5202, 0.0162, 0.5997, 0.0217),
    7998 : PolarizationRecord(7998, 'final',    0.5434, 0.0274, 0.5211, 0.0303),
    8003 : PolarizationRecord(8003, 'final',    0.4203, 0.0251, 0.5367, 0.0302),
    8005 : PolarizationRecord(8005, 'final',    0.4541, 0.0244, 0.5523, 0.0257),
    8008 : PolarizationRecord(8008, 'final',    0.5258, 0.0267, 0.5644, 0.0241),
    8014 : PolarizationRecord(8014, 'final',    0.5094, 0.0193, 0.5243, 0.0198),
    8015 : PolarizationRecord(8015, 'final',    0.5100, 0.0216, 0.4942, 0.0182),
    8016 : PolarizationRecord(8016, 'final',    0.4564, 0.0199, 0.4839, 0.0176),
    8020 : PolarizationRecord(8020, 'final',    0.5220, 0.0278, 0.4581, 0.0213),
    8021 : PolarizationRecord(8021, 'final',    0.4847, 0.0214, 0.4618, 0.0171),
    8022 : PolarizationRecord(8022, 'final',    0.4856, 0.0197, 0.4515, 0.0174),
    8023 : PolarizationRecord(8023, 'final',    0.5242, 0.0211, 0.5170, 0.0223),
    8024 : PolarizationRecord(8024, 'final',    0.4563, 0.0157, 0.4879, 0.0285),
    8025 : PolarizationRecord(8025, 'final',    0.4938, 0.0279, 0.5106, 0.0331),
    8026 : PolarizationRecord(8026, 'final',    0.5161, 0.0303, 0.5050, 0.0351),
    8031 : PolarizationRecord(8031, 'final',    0.4647, 0.0236, 0.4887, 0.0294),
    8032 : PolarizationRecord(8032, 'final',    0.4799, 0.0177, 0.4694, 0.0184),
    8036 : PolarizationRecord(8036, 'final',    0.5358, 0.0415, 0.4303, 0.0156),
    8047 : PolarizationRecord(8047, 'final',    0.4753, 0.0307, 0.4582, 0.0208),
    8048 : PolarizationRecord(8048, 'final',    0.5357, 0.0239, 0.5232, 0.0351),
    8049 : PolarizationRecord(8049, 'final',    0.5076, 0.0224, 0.5338, 0.0176),
    8052 : PolarizationRecord(8052, 'final',    0.5022, 0.0467, 0.5074, 0.0327),
    8053 : PolarizationRecord(8053, 'final',    0.5835, 0.0508, 0.4798, 0.0285),
    8054 : PolarizationRecord(8054, 'final',    0.5077, 0.0161, 0.4602, 0.0134),
    8055 : PolarizationRecord(8055, 'final',    0.4747, 0.0430, 0.5029, 0.0367),
    8056 : PolarizationRecord(8056, 'final',    0.4558, 0.0262, 0.4867, 0.0124),
    8058 : PolarizationRecord(8058, 'final',    0.4724, 0.0228, 0.5007, 0.0149),
    8059 : PolarizationRecord(8059, 'final',    0.4892, 0.0209, 0.4684, 0.0206),
    8061 : PolarizationRecord(8061, 'final',    0.5162, 0.0294, 0.4525, 0.0374)
    }
    Online = {
