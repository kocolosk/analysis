...
class AsymmetryGenerator:
   ...
   def __init__(self, name, usePolarizations = True, useR123 = True, bins = [4, 2.0, 10.0], key='pt'):
      self.name = name
      self.bins = bins
      self.key  = key
      if len(self.bins) == 3:
...
def transverse_relative_luminosity_run5(tfile):
    ...
    for run in analysis.transverse_run5:
        ...
        for timebin in range(15):
            ...
            print '%d %d 5 %2d %d %d %d %d' % (fill, run, timebin+1, tree.N5, tree.N6, tree.N9, tree.N10)
